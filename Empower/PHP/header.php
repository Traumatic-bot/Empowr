...
<header>
            ...
            <div class="basket-links">
                <a id="basket-links" href="#"
                   style="margin-left:20px; padding-left: 5px; display: flex; justify-content: center; align-items: center;">
                    ...
                    <span class="price" style="margin-left: 3px; margin-right: 3px;">£<?php echo $cartTotal; ?></span>
    ...
    <div id="popupBackground"
         style="cursor: pointer; height: 100%; left: 0; opacity: 0.7; position: fixed; top: 0;
    ...
    <div id="popup" style="display:none;">
        ...
        <div class="productList"
             style="min-height: 132px; max-height: 300px; overflow-y: auto;
        ...
        <div class="subTotal" style="margin: 18px 15px 0; border-top: 4px solid #e2e2e2;">
            <ul style="padding: 0; margin: 5px; list-style:none;">
                <li style="display: table; width: 100%; border-bottom: 1px solid #e2e2e2; height: 50px; text-align: left;">
    ...
    <ul class="topnav">
        ...
        <li><a href="products.php?category=Desks & Chairs">Desks & Chairs</a></li>
        <li><a href="products.php?category=Cameras & Microphones">Cameras & Microphones</a></li>
    </ul>
</header>