                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><span class="order-status <?php echo $status_class; ?>"><?php echo htmlspecialchars($order['status']); ?></span></td>
                                <td><a href="order_details.php?id=<?php echo $order['order_id']; ?>" class="view-order">View</a></td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
