...
<main>
    ...
    <div class="about-container">
        <div class="section-modern">
            ...
            <p class="last-updated">Last updated: 19 Mar 2026</p>

            <h2>We Respect Your Privacy</h2>
            <p>
                Empowr Tech ("we", "us", "our") is committed to protecting the privacy of everyone who visits or shops with us.
                As an assistive technology retailer, we understand that trust is especially important to our customers.
                This policy explains what personal data we collect, how we use it, and your rights.
            </p>
            <p>Empowr Tech is the data controller of any personal data you provide to us. This policy is reviewed and updated periodically.</p>
            <p>
                You can contact us at:<br>
                <b>Empowr Tech</b>, 123 Aston Lane, City Centre, CV1 1JB<br>
                Email: <a href="mailto:support@empowrtech.com">support@empowrtech.com</a>   |   Phone: 01234 567890
            </p>
            ...
            <ul>
                ...
                <li>Updating your preferences in My Account</li>
            </ul>
            <p>We may also send emails about items relevant to your browsing or wishlist activity. You can opt out of these at any time via the unsubscribe link in the email footer.</p>

            <h2>Advertising and Cookies</h2>
            <p>With your explicit consent, we may share anonymised browsing data with advertising partners including Google Ads, Criteo, and Quantcast for targeted advertising. You can withdraw consent at any time via our cookie settings or Privacy Dashboard.</p>
            <p>To opt out of third-party advertising more broadly, visit <a href="http://www.youronlinechoices.com/uk/your-ad-choices" target="_blank">youronlinechoices.com</a> or <a href="https://www.google.com/settings/ads" target="_blank">google.com/settings/ads</a>.</p>
            <p>For full details on cookies, please see our Cookie Policy.</p>
            ...
            <h2>Your Rights</h2>
            <p>Under UK data protection law and the UK GDPR, you have the right to:</p>
            <ul>
                <li>Access the personal data we hold about you</li>
                <li>Have inaccurate data corrected</li>
                <li>Request erasure of your data (note: this right is not absolute)</li>
                <li>Restrict or object to how we process your data</li>
                <li>Download your data via My Account (data portability)</li>
            </ul>
            <p>To exercise any of these rights, please contact us at <a href="mailto:support@empowrtech.com">support@empowrtech.com</a>. We will respond within one calendar month.</p>

            <h2>Contact Us</h2>
            <p>If you have any questions about this policy or how we handle your personal data, please get in touch:</p>
            <p>
                <b>Empowr Tech</b><br>
                123 Aston Lane, City Centre, CV1 1JB<br>
                <a href="mailto:support@empowrtech.com">support@empowrtech.com</a>
            </p>
