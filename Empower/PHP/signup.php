        ...
        <form method="post" action="">
            <div class="input-container">
                <select class="input-field" style="width: 100%;" name="title">
                    <option value="Mr"
                        <?php echo isset($_POST['title']) && $_POST['title'] == 'Mr' ? 'selected' : ''; ?>>Mr</option>
                    <option value="Mrs"
                        <?php echo isset($_POST['title']) && $_POST['title'] == 'Mrs' ? 'selected' : ''; ?>>Mrs</option>
                    <option value="Miss"
                        <?php echo isset($_POST['title']) && $_POST['title'] == 'Miss' ? 'selected' : ''; ?>>Miss
                    </option>
                    <option value="Ms"
                        <?php echo isset($_POST['title']) && $_POST['title'] == 'Ms' ? 'selected' : ''; ?>>Ms</option>
                    <option value="Dr"
                        <?php echo isset($_POST['title']) && $_POST['title'] == 'Dr' ? 'selected' : ''; ?>>Dr</option>
                    <option value="Mx"
                        <?php echo isset($_POST['title']) && $_POST['title'] == 'Mx' ? 'selected' : ''; ?>>Mx</option>
                    <option value="Other"
                        <?php echo isset($_POST['title']) && $_POST['title'] == 'Other' ? 'selected' : ''; ?>>Other
                    </option>
                </select>
