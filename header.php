...
// Dark mode should /can be toggled by any user guest/ or alrady logged in
$darkModeOn = false;
if ($isLoggedIn && isset($_SESSION['user_id'])) {
    $darkModeOn = function_exists('isDarkModeEnabled') ? isDarkModeEnabled($_SESSION['user_id']) : false;
} else {
    $darkModeOn = (isset($_COOKIE['empowr_darkmode']) && $_COOKIE['empowr_darkmode'] === '1');
}
...
<body <?php echo $darkModeOn ? 'class="dark-mode"' : ''; ?>
            ...
            <div class="header-links" style="width: 550px; display: flex; align-items: center; height: 50px;">
                ...
                <div class="darkmode-toggle" style="margin-left: 20px;">
                    <a href="toggle_darkmode.php" id="darkmode-toggle-btn"
                        title="<?php echo $darkModeOn ? 'Switch to Light Mode' : 'Switch to Dark Mode'; ?>"
                        ...
                        <span id="darkmode-icon" style="margin-right: 5px; display: inline-flex;" aria-hidden="true">
                            <?php if ($darkModeOn): ?>
                        ...
                        <span id="darkmode-text" style="font-size: 12px;">
                            <?php echo $darkModeOn ? 'Light' : 'Dark'; ?>
                        </span>
                    </a>
                </div>
            </div>
